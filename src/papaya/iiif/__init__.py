...
SEARCH_API_1_CONTEXT = 'http://iiif.io/api/search/1/context.json'
SEARCH_API_1_PROFILE = 'http://iiif.io/api/search/1/search'

DEFAULT_THUMBNAIL_WIDTH = 250
DEFAULT_UNAVAILABLE_IMAGE_ID = 'static:unavailable'
